...
const Contact = () => {
  useDocTitle("KW | Kloud Waves - Send us a message");
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(function (response) {
        ...
        clearInput();
        //handle success
        Notiflix.Report.success("Success", response, "Okay");
      })
            ...
            <div className="flex flex-col text-white">
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Tel: +1 647-463-1982</p>
*/}
                  <div className="mt-5">
                    <h2 className="text-2xl">Send an E-mail</h2>
                    <p className="text-gray-400">info@kloudwaves.ca</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                <a
                  href="https://www.facebook.com/profile.php?id=61551677894615"
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href="https://www.linkedin.com/in/kloud-waves"
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1"
                >
